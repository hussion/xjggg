...
const Form = () => {
  ...
  return (<div>
      <h1 className='title md:max-w-3xl w-full md:mx-auto'>小桔GPT</h1>
      <div className='top-action flex justify-between md:max-w-3xl w-full md:mx-auto'>
        <div><span className='text-gray-500'>Models: </span><select
          value={currentModel}
          onChange={handleModelChange}
          className='modelSelect w-72 outline-none p-4 rounded-md bg-white text-gray-500 dark:hover:text-gray-400 dark:hover:bg-gray-900'
        >
          {models.map((model) => (
        ...
        <button
          onClick={handleReset}
          type='reset'
          className='p-4 rounded-md bg-slate-400 text-white dark:hover:text-gray-400 dark:hover:bg-gray-900 disabled:hover:bg-transparent dark:disabled:hover:bg-transparent'
        >
          Clear History
        </button>
      </div>
